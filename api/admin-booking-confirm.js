...
export default async function handler(req,res){
  ...
  try{
    ...
    if(updated.email&&gmailReady())try{await sendMail({to:updated.email,subject:updated.isTest?"俐姐的家｜【測試】預約流程已完成":"俐姐的家｜您的預約已確認",text:confirmedEmailText(updated)});emailSent=true}catch(e){console.warn("confirm email failed",e)}
