...
export function confirmedEmailHtml(b){
  ...
  const lis=stayItems.map((item,i)=>`<li style="margin:0 0 10px;padding-left:2px;line-height:1.75"><span style="font-weight:700;color:#173a35">${i+1}.</span> ${esc(item)}</li>`).join("");
